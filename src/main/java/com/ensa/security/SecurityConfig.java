...
//		http.formLogin();
		http.authorizeRequests().antMatchers("/login/**","/demandeurs/register/**"
				,"/equipements/**","/demandes/**").permitAll();
		http.authorizeRequests().antMatchers(HttpMethod.GET,"/gestionnaires/**").hasAuthority("ADMIN");
